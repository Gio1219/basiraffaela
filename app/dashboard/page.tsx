...
import { Music, Upload, LogOut, FileAudio, Camera, MessageSquare, Download, Trash2, Play, Pause, Activity, RotateCcw, RotateCw, Sliders, X, Maximize2, Minimize2 } from "lucide-react";
        ...
        return (
          <>
            ...
            <div className="fixed bottom-6 right-6 z-50 bg-white border border-stone-200 shadow-2xl rounded-2xl p-4 w-80 sm:w-96 space-y-3 animate-fadeIn">
              <div className="flex items-center justify-between">
                <span className="text-[9px] font-bold tracking-widest text-[#7A2238] uppercase">In riproduzione</span>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="overflow-hidden flex-1">
                  ...
                  <p className="text-[11px] text-stone-500 truncate">{activeTrack.artista} {activeTrack.tonalita ? `· ${activeTrack.tonalita}` : ''}</p>
                </div>
              </div>
            ...
            {isExpandedPlayer && (
              <div className="fixed inset-0 z-50 bg-[#FCFBF9] flex flex-col justify-between p-6 sm:p-12 animate-fadeIn">
                <div className="flex items-center justify-between max-w-4xl w-full mx-auto">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[11px] text-stone-500">Nuova Accademia Toscanini</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    {activeTrack.commento && (
                      <div className="mt-4 max-w-md mx-auto bg-[#7A2238]/10 border border-[#7A2238]/20 rounded-2xl p-4 text-xs text-stone-800 text-left">
                        <span className="font-bold text-[#7A2238] block mb-1 uppercase tracking-wider text-[10px]">Feedback Insegnante:</span>
                        {activeTrack.commento}
                      </div>
                    )}
                  </div>
                ...
                <div className="text-center text-xs text-stone-400">
                  Nuova Accademia Toscanini · Canto Moderno
                </div>
              </div>
            )}
          </>
